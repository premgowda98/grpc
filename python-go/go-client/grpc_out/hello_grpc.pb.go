...
const (
	HelloWorld_Hello_FullMethodName = "/helloPackage.HelloWorld/hello"
	HelloWorld_Age_FullMethodName   = "/helloPackage.HelloWorld/age"
)
...
type HelloWorldClient interface {
	...
	Age(ctx context.Context, in *AgeRequest, opts ...grpc.CallOption) (*AgeResponse, error)
}
...
func (c *helloWorldClient) Age(ctx context.Context, in *AgeRequest, opts ...grpc.CallOption) (*AgeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AgeResponse)
	err := c.cc.Invoke(ctx, HelloWorld_Age_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	...
	Age(context.Context, *AgeRequest) (*AgeResponse, error)
...
func (UnimplementedHelloWorldServer) Age(context.Context, *AgeRequest) (*AgeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Age not implemented")
}
...
func _HelloWorld_Age_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AgeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).Age(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorld_Age_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).Age(ctx, req.(*AgeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloWorld_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helloPackage.HelloWorld",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "age",
			Handler:    _HelloWorld_Age_Handler,
		},
	},
