...
import grpc_out.hello_pb2 as hello__pb2
...
class HelloWorldStub(object):
    ...
    def __init__(self, channel):
        ...
        self.age = channel.unary_unary(
                '/helloPackage.HelloWorld/age',
                request_serializer=hello__pb2.AgeRequest.SerializeToString,
                response_deserializer=hello__pb2.AgeResponse.FromString,
                _registered_method=True)
...
def add_HelloWorldServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'age': grpc.unary_unary_rpc_method_handler(
                    servicer.age,
                    request_deserializer=hello__pb2.AgeRequest.FromString,
                    response_serializer=hello__pb2.AgeResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'helloPackage.HelloWorld', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('helloPackage.HelloWorld', rpc_method_handlers)
...
class HelloWorld(object):
    ...
    def age(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/helloPackage.HelloWorld/age',
            hello__pb2.AgeRequest.SerializeToString,
            hello__pb2.AgeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
